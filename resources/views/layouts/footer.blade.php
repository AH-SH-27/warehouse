<footer class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-8 md:flex-row items-center flex-wrap justify-between">
            ...
            <div class="flex flex-col items-center justify-center gap-5">
                ...
                <div class="flex justify-center my-2 md:my-0 space-x-4">
                    <a href="#" class="hover:text-blue-500">
                        <svg class="h-6 w-6 hover:fill-blue-500" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <a href="#" class="hover:text-blue-500">
                        <svg class="h-6 w-6 hover:fill-blue-500" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div class="flex flex-col items-end justify-end">
                <div class="text-right flex flex-col gap-5">
                    <p class="inline-flex gap-2">
                        <svg class="h-5 w-5 hover:fill-blue-500" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" />
                        </svg>
                        Phone: 123456789
                    </p>
                    <p class="inline-flex gap-2 text-nowrap">
                        <svg class="h-5 w-5 hover:fill-blue-500" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <a href="#" class="bg-blue-500 hover:bg-blue-800 p-3 rounded-full transition duration-300 ease-in-out flex items-center justify-center mb-3">
